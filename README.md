...
This project uses the PAD-UFES-20 dataset. <br>
Due to its size and licensing, the dataset is not included in this repository. <br>
Please download it from the official source and place it in the data/ directory. <br>
